...
import FinanceTrackerWidget from './widgets/FinanceTrackerWidget';
...
function App() {
 const [widgets, setWidgets] = useState([
  ...
  { id: new Date().getTime() + 1, component: <FinanceTrackerWidget />, area: 'main-widget', name:"Simple Finance Tracker" },
 ])
